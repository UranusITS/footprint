...
exports.default = {
  ...
  open_api_tips1:
    'onlinedoc开放文档编辑的API，供使用者更加方便地操作文档数据。<br>利用开放API，你可以自动化地完成很多事',
  open_api_tips2:
    '如果你想自动化生成API文档，则可参考<a target="_bank" href="https://www.onlinedoc.cc/page/741656402509783">API文档</a>',
  open_api_tips3:
    '如果你想自动化生成数据字典，则可参考<a target="_bank" href="https://www.onlinedoc.cc/page/312209902620725">数据字典</a>',
  open_api_tips4:
    '如果你更自由地生成自己所需要的格式，则可参考<a target="_bank" href="https://www.onlinedoc.cc/page/102098">开放API</a>',
  ...
  welcome_use_onlinedoc: '欢迎使用onlinedoc！',
  templ_list: '模板列表',
  templ_title: '模板标题',
  no_templ_text:
  ...
  long_page_tips:
    '检测到本页面内容比较多，onlinedoc暂时关闭了html实时预览功能，以防止过多内容造成页面卡顿。你可以在编辑栏中找到预览按钮进行手动打开。',
  ...
  cat_tips: '可拖动以排序',
  cat_limite_tips: 'onlinedoc只支持最多三层目录，请优化目录结构',
  ...
  import_file_tips1:
    '导入的文件可以是<b>postman</b>的json文件、<b>swagger3</b>的json文件、onlinedoc的<b>markdown压缩包</b>。系统会自动识别文件类型。',
  import_file_tips2: '将文件拖到此处，或<em>点击上传</em>',
  export_format_word: 'word格式',
  export_format_markdown: 'markdown压缩包',
  export_markdown_tips:
    '导出的压缩包可以重新导入onlinedoc，在新建项目的时候选择“文件导入”即可',
  ...
  your_onlinedoc_server: '【你的onlinedoc地址】',
  ...
  site_url: '网站外部访问url',
  site_url_tips:
    '你上传图片/附件等资源时，其生成的url自动由程序判断填充。如果程序判断错误，你可以在这里手动填上访问url，当你填写后，上传资源后的访问url将使用这里填写的值作为访问前缀。填写示例值"https://www.onlinedoc.com.cn"。如果你不理解此值含义，请默认留空，不要填写',
