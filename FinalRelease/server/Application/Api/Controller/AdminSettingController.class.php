    ...
    public function saveLdapConfig()
    {
        ...
        if ($ldap_open) {
            ...
            if (!extension_loaded('ldap')) {
                $this->sendError(10011, "你尚未安装php-ldap扩展。如果是普通PHP环境，请手动安装之。如果是使用之前官方docker镜像，则需要重新安装镜像。方法是：备份 /onlinedoc_data 整个目录，然后全新安装onlinedoc，接着用备份覆盖/onlinedoc_data 。然后递归赋予777可写权限。");
                return;
            }
