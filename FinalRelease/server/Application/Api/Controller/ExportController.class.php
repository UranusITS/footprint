...
class ExportController extends BaseController
{
    ...
    public function markdown()
    {
        ...
        $temp_file = tempnam(sys_get_temp_dir(), 'Tux') . "_onlinedoc_.zip";
        $temp_dir = sys_get_temp_dir() . "/onlinedoc_" . time() . rand();
        mkdir($temp_dir);
        ...
        header('Content-disposition: attachment; filename=onlinedoc.zip'); // 文件名
