...
class UpdateController extends BaseController
{
    ...
    public function db()
    {
        ...
        if (strtolower(C("DB_TYPE")) == 'mysql') {
            //$this->mysql();
            echo 'onlinedoc does not support mysql any more . https://www.onlinedoc.cc/help?page_id=31990 ';
    ...
    public function sqlite()
    {
        ...
        if (D("User")->where("username = 'onlinedoc' ")->find()) {
            D("User")->where("username = 'onlinedoc' ")->save(array("groupid" => 1));
        } else {
            D("User")->add(array('username' => "onlinedoc", "groupid" => 1, 'password' => "a89da13684490eb9ec9e613f91d24d00", 'reg_time' => time()));
        }
    ...
    public function toSqlite()
    {
        ...
        if (strtolower(C("DB_TYPE")) == 'mysql') {
            ...
            $db_config = array(
                'DB_TYPE'   => 'Sqlite',
                'DB_NAME'   => 'Sqlite/onlinedoc.db.php',
            );
